...
class User(db.Model):
    ...
    role = db.Column(db.String(20), nullable=False, default='visor')  # leader, co_leader, visor
...
class Member(db.Model):
    ...
    # العلاقات
    points = db.relationship('Point', backref='member', cascade='all, delete-orphan')
...
class Point(db.Model):
    ...
    point_type = db.Column(db.String(10), nullable=False)  # positive, negative
...
class Log(db.Model):
    ...
    id = db.Column(db.Integer, primary_key=True)
    action_type = db.Column(db.String(50), nullable=False)  # create, update, delete, login
    target_type = db.Column(db.String(20), nullable=False)  # user, member, point
